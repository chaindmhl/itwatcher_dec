...
from .models import Video, PlateLog, CountLog, VehicleLog, ColorLog, NVRVideo, ViolationLog
...
class ViolationLogAdmin(admin.ModelAdmin):
    list_display = ('timestamp', 'video_file','display_vehicle_image', 'vehicle_type','vehicle_color', 'display_plate_image', 'plate_number', 'display_frame_image',  'violation' )  # Include 'display_plate_image' here
