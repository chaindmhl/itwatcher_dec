...
def process_trackcount_all(video_path=None, livestream_url=None, is_live_stream=False, video_stream=None):
    ...
    if video_path:
        ...
        output_video_path = os.path.join(output_folder_path, f"tracked_all_{os.path.basename(video_path)}")
