...
class Plate_Recognizer:
    def __init__(self, weights_path = "darknet/LPD1/lpd.weights", config_path = "darknet/LPD1/lpd.cfg", class_names_path = "darknet/LPD1/lpd.names", confidence_threshold=0.5, nms_threshold=0.4):
